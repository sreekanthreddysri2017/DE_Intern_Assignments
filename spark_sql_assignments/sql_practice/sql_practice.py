...
insert into employee_details values('James','Sales',3000),('Michael','Sales',4600),('Robert','Sales',4100)

,('Maria','Finance',3000),('Raman','Finance',3000),('Scott','Finance',3300)

,('Jen','Finance',3900),('Jeff','Marketting',3000),('Kumar','Marketting',2000)

select * from employee_details

select * from employee_details  limit 1;
SELECT * FROM  employee_details LIMIT 2;
select emp_name,max(salary) from employee_details group by department;
